...
// Declare client level module which depends on filters, and services
        ...
        resolve: { // Any property in resolve should return a promise and is executed before the view is loaded
          loadOcModal: ['$ocLazyLoad', '$injector', '$rootScope', function($ocLazyLoad, $injector, $rootScope) {
            ...
            return $ocLazyLoad.load({
              name: 'oc.modal',
              files: [
                'vendor/bootstrap/dist/css/bootstrap.css', // will use the cached version if you already loaded bootstrap with the button
                'vendor/ocModal/dist/css/ocModal.animations.css',
                'vendor/ocModal/dist/css/ocModal.light.css',
                'vendor/ocModal/dist/ocModal.js',
                'partials/modal.html'
              ]
            }).then(function() {
