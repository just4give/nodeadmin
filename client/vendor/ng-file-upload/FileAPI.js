			...
			upload: function (options){
				...
				_nextFile = function (){
					...
					if( _file && _file.name === api.expando ){
						_file = null;
						api.log('[warn] FileAPI.add-product() — called without files');
					}
...
//									});
					...
					_inherit(api.XHR.prototype, {
						_send: function (options, formData){
							...
							// #2174: FileReference.load() call while FileReference.add-product() or vice versa
							_each(files, function (file){
								queue.inc();
